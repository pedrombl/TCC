...
The project used the Design Pattern Strategy[\citet{GOF1995}] in the implementation of the scalability increase functionality. The Strategy structure is presented in Figure \ref{strategyStructure}. 
